...
export default function Login({
    ...
    return (
        ...
        >
                    ...
                    <>
                        <div className="grid gap-4">
                            ...
                            <div className="grid gap-1.5">
                                <div className="flex items-center justify-between">
                                    ...
                                    {canResetPassword && (
                                        <TextLink
                                            href={request()}
                                            className="text-xs font-extrabold text-[#ED1C24] hover:text-[#ED1C24]/80 transition-colors"
                                            tabIndex={5}
                                        >
                                            Forgot?
                                        </TextLink>
                            ...
                            <div className="flex items-center space-x-2.5 py-1">
                                <Checkbox
                                    ...
                                    name="remember"
                                    tabIndex={3}
                                    className="rounded border-neutral-300 dark:border-neutral-800 data-[state=checked]:bg-[#ED1C24] data-[state=checked]:border-[#ED1C24]"
                                />
                                <Label htmlFor="remember" className="text-xs font-bold text-neutral-600 dark:text-neutral-400 select-none cursor-pointer">
                                    Keep me logged in
                                </Label>
                            </div>
                        ...
                        {canRegister && (
                            <div className="text-center text-xs font-bold text-muted-foreground mt-2">
                                ...
                                <TextLink href={register()} tabIndex={6} className="text-[#ED1C24] hover:underline font-extrabold transition-all">
                                    Sign Up
                                </TextLink>
                            </div>
                        )}
            ...
            {status && (
                <div className="mt-4 text-center text-sm font-medium text-green-600 bg-green-50 dark:bg-green-950/20 py-2 rounded-lg border border-green-150 dark:border-green-900/30 animate-in fade-in duration-300">
                    {status}
                </div>
            )}
        </AuthLayout>
